      ...
      <nav className="sidebar-nav">
        <ul>
          ...
          <li className={`relative menu-item ${menusAbertos.orcamentos ? 'open' : ''}`}>
            ...
            <ul className={`list-none pl-8 mt-2 ${menusAbertos.orcamentos ? 'block' : 'hidden'}`}>
              <li><NavLink to="/orcamentos" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/orcamentos' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Lista de Orçamentos</span></NavLink></li>
              <li><NavLink to="/orcamentos/novo" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/orcamentos/novo' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Criar Orçamento</span></NavLink></li>
              <li><NavLink to="/bases-de-preco" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/bases-de-preco' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Bases de Preço</span></NavLink></li>
            </ul>
          </li>
          ...
          {/* Menu Expansível: Financeiro */}
          <li className={`relative menu-item ${menusAbertos.financeiro ? 'open' : ''}`}>
            <Button type="button" variant="ghost" className="flex items-center justify-between gap-4 py-2 px-4 text-gray-200 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full hover:bg-slate-600 hover:text-white" onClick={() => toggleMenu('financeiro')}>
              <div className="flex items-center gap-4">
                <i className="fa-solid fa-dollar-sign"></i>
                <span className={`text-base ${isSidebarExpanded ? 'block' : 'hidden'}`}>Financeiro</span>
              </div>
              <i className={`fa-solid fa-chevron-right transition-transform duration-300 ease ${menusAbertos.financeiro ? 'rotate-90' : ''} ${isSidebarExpanded ? 'block' : 'hidden'}`}></i>
            </Button>
            <ul className={`list-none pl-8 mt-2 ${menusAbertos.financeiro ? 'block' : 'hidden'}`}>
              <li><NavLink to="/financeiro/contas-a-pagar" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/financeiro/contas-a-pagar' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Contas a Pagar</span></NavLink></li>
              <li><NavLink to="/financeiro/contas-a-receber" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/financeiro/contas-a-receber' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Contas a Receber</span></NavLink></li>
              <li><NavLink to="/financeiro/fluxo-de-caixa" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/financeiro/fluxo-de-caixa' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Fluxo de Caixa</span></NavLink></li>
            </ul>
          </li>
          ...
          <li className={`relative menu-item ${menusAbertos.cadastros ? 'open' : ''}`}>
            ...
            <ul className={`list-none pl-8 mt-2 ${menusAbertos.cadastros ? 'block' : 'hidden'}`}>
              <li><NavLink to="/clientes" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/clientes' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Clientes</span></NavLink></li>
              <li><NavLink to="/fornecedores" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/fornecedores' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Fornecedores</span></NavLink></li>
              <li><NavLink to="/cadastros/recursos" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/cadastros/recursos' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Recursos</span></NavLink></li>
              <li><NavLink to="/cadastros/obras" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/cadastros/obras' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>Obras</span></NavLink></li>
              <li><NavLink to="/bdi" className={`flex items-center gap-4 py-1.5 px-3 text-gray-300 rounded-md font-medium transition-all duration-300 ease-in-out whitespace-nowrap w-full text-xs ${location.pathname === '/bdi' ? 'bg-accent text-white font-semibold' : 'hover:bg-slate-600 hover:text-white'}`}><span className={`${isSidebarExpanded ? 'block' : 'hidden'}`}>BDI</span></NavLink></li>
